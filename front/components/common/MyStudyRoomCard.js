        ...
        {myStudyRoom.group === false ? (
          ...
          <a href={`/studyroom/private`} aria-label="Article">
            <div className="bg-blue-900 h-[300px] w-[250px] rounded-xl overflow-hidden transition-shadow duration-300">
              <p className="mt-3 ml-2 font-bold text-orange-300"></p>
          ...
          <a
            ...
            aria-label="Article"
          >
            <div className="bg-indigo-300 h-[300px] w-[250px] rounded-xl overflow-hidden transition-shadow duration-300">
