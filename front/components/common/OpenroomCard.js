export default function OpenroomCard({ openRoom }) {
  return (
    <a href={`/openroom/board/${openRoom.roomId}`} aria-label="Article">
      {/* <!-- card --> */}
      <div class="mx-auto my-[3rem] flex h-[300px] w-[250px] flex-col justify-center bg-gradient-to-r from-purple-100 to-teal-50 rounded-2xl shadow-xl shadow-slate-300/60">
        {/* <!-- img --> */}
        <img
