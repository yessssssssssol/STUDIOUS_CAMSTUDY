const PrologueTop = () => {
  return (
    <div>
      {/*  */}
      <div className="w-full bg-center bg-cover h-screen bg-[url('https://images.unsplash.com/photo-1504384308090-c894fdcc538d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80')]">
