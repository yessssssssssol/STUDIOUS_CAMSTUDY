...
export default function NavBarIcon2(){
    ...
    function NavItem(item,index){
        return(
            <li key={index}>
          <Link href="/"><a href="#" class="block py-2 pr-4 pl-3  mx-20 font-semibold text-gray-700 border-b border-gray-500 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">{item}</a></Link>
        </li>
        )
    }
